      ...
      <section className="bg-white border-y border-line">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
          <SectionHeader
            ...
            title="From your camera roll to your bank in 4 steps"
          />
        ...
        <div className="flex items-end justify-between mb-6 flex-wrap gap-3">
          <div>
            ...
            <h2 className="font-display text-3xl md:text-4xl font-bold mt-2">
              Live submissions from reporters
            </h2>
          </div>
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 p-8 md:p-14">
            <div>
              ...
              <p className="text-white/70 mt-4 max-w-xl">
                The biggest one-off payout last month was £14,200. Most reporters earn between £40
                and £900 per accepted submission. You decide what to send.
              </p>
...
function PhoneMock() {
  return (
    <div className="relative mx-auto w-full max-w-sm">
        ...
        <div className="h-full w-full bg-paper p-3 flex flex-col gap-2 overflow-hidden">
          ...
          <div className="rounded-2xl bg-white border border-line p-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-[11px] text-mute">Police spotting</div>
                <div className="font-semibold text-sm">£180 estimate</div>
              </div>
              <div className="ml-auto chip chip-amber">Review</div>
            </div>
          </div>
      ...
      <div className="absolute -bottom-4 -left-3 -rotate-6 bg-white text-ink px-3 py-1 rounded-full text-xs font-bold shadow-soft border border-line">
        Newsroom verified
      </div>
    </div>
  )
