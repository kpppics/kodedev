      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <aside className="space-y-5">
          ...
          {isOwner ? (
            ...
            <div className="card p-5">
              ...
              <p className="text-sm text-mute mt-2">
                This shot is being pitched to verified newsrooms in the UK and abroad. Want to send
                in your own?
              </p>
              <Link href="/upload" className="btn btn-primary w-full mt-4">
                <span className="material-symbols-outlined" style={{ fontSize: 18 }}>
                  add_a_photo
                </span>
                Upload your shot
          ...
          <div className="card p-5 bg-[#0b1020] text-white border-[#0b1020]">
            ...
            <Link href="/safety" className="text-brand-light text-sm font-semibold mt-3 inline-flex">
