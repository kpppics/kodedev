      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-16 text-center">
        <div className="card p-10">
          ...
          <div className="flex gap-3 justify-center mt-6">
            <Link href="/capture-press/signin" className="btn btn-primary">Sign in</Link>
            <Link href="/capture-press/signin?mode=signup" className="btn btn-light">Create account</Link>
          </div>
        </div>
      </div>
    )
