    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="card p-6 md:p-10 mt-10 bg-[#0b1020] text-white border-[#0b1020]">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          <Link href="/capture-press/upload" className="btn btn-primary">Upload now</Link>
          <Link href="/capture-press/signin?mode=signup" className="btn btn-ghost">Create account</Link>
        </div>
      </div>
