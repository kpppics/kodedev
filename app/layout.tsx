...
export const metadata: Metadata = {
  ...
  keywords:
    'capture press, sell photos, citizen journalism, celeb spotting, breaking news photos, sell videos, paparazzi, paid news photos',
  authors: [{ name: 'Capture Press' }],
  robots: 'index, follow',
  openGraph: {
    type: 'website',
    title: 'Capture Press — Snap it. Send it. Get paid.',
    description:
      'Earn money for the photos and videos already on your phone. Celebrity spottings, breaking news, crime, events.',
